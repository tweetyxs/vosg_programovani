...
[RequireComponent(typeof (Rigidbody))]
    ...
    internal void SetFocus(IUsable focusedObject)
    {
        _focusedUsable = focusedObject;       
    }
    ...
    public Vector3 Velocity
        ...
        private void Update()
        {
            ...
            /*if (Physics.Raycast(_camera.transform.position, _camera.transform.forward, out result, DistanceToUse))
            {
            ...
            {
                if(_focusedUsable != null)
                    _focusedUsable.Use();
            }

            if (Input.GetKeyDown (KeyCode.I))
            {
                LevelManager.Instance.Inventory.ShowInventory();
            }
